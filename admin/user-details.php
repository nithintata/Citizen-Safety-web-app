...
$id = $_GET['q'];
$sql = "SELECT * FROM report WHERE id like '$id'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_assoc($result)) {
  $uid = $row['userUid'];
  $bor = $row['boarding'];
  $dest = $row['destination'];
  $vhnum = $row['vehicleNum'];
  $image = $row['name'];
  $latlng = $row['latlng'];
}
...
<p><b>Boarding :</b> <?php  echo $bor;    ?></p>
<p><b>Destination : </b><?php  echo $dest;    ?></p>
<p><b>Vehicle Number : </b><?php  echo $vhnum;    ?></p>
<p><b>Position :</b></p>
